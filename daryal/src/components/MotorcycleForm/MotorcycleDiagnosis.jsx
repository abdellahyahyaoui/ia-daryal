...
//       {state.step === "vehicleForm" && <MotorcycleForm onSubmit={handleVehicleSubmit} />}
//       {state.step === "chat" && (
//         <ChatInterface
      ...
      {state.step === "chat" && (
        <>
          {/* <div className="diagnosis-header">
            <h2>Vamos a diagnosticar tu {state.vehicleData?.tipo_moto || "moto"}</h2>
            <div className="vehicle-info">
              {state.vehicleData && (
                <span>
                  {state.vehicleData.marca} {state.vehicleData.modelo} ({state.vehicleData.año}) -{" "}
                  {state.vehicleData.combustible}
                </span>
              )}
            </div>
          </div> */}
