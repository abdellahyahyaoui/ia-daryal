...
function OrbeaDiagnosis() {
  ...
  const renderComponent = (type) => {
    switch (type) {
      case "vehicleForm":
        return <OrbeaForm onSubmit={handleVehicleSubmit} />
      default:
        return null
    }
  }
    ...
    <div className="orbea-diagnosis">
      ...
      {(state.step === "vehicleForm" || state.step === "chat" || state.step === "diagnosis") && (
        <ChatLayout
          ...
          .concat(state.step === "vehicleForm" ? [{ sender: "ai", text: "Por favor, completa los datos de tu Orbea.", component: "vehicleForm" }] : [])
